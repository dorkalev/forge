...
```bash
git log origin/main..origin/staging --format="%s%n%b" | grep -oE "ENG-[0-9]+" | sort -u
```
...
|----|-------|--------|--------|------------|
| #108 | ENG-407: Session auth... | @dorkalev | 2026-02-04 | Archived |
| #106 | ENG-396: Simplify velocity... | @dorkalev | 2026-02-03 | Archived |
...
| Ticket | Title | Status |
|--------|-------|--------|
| [ENG-407](url) | Session auth for browser API | Done |
| [ENG-396](url) | Simplify rolling average | Done |
| [ENG-411](url) | Fix LLM analyst inspection | Done |
...
- Batch aggregation over clean windows
...
2. Trigger production deployment to acme-core
...
```json
{
  ...
  "pull_requests": [
    {
      "number": 108,
      "title": "ENG-407: Session auth...",
      "url": "https://github.com/...",
      "author": "dorkalev",
      "merged_at": "2026-02-04T09:57:20Z",
      "compliance_archive": "compliance/pr-108-ENG-407-session-auth-...-20260204.json"
    }
  ],
  ...
  "linear_tickets": [
    {
      ...
      "url": "https://linear.app/acme/issue/ENG-407",
      "status": "Done"
    }
  ],
  ...
  "change_summary": {
    ...
    "worker": ["Rolling average", "Batch aggregation"],
  ...
  "ci_status": {
    "staging_sha": "{sha}",
    "status": "success",
    "checks_passed": ["worker-test", "web-test", "soc2-compliance"]
  },
...
|----|-------|--------|--------|-------------------|
| [#108]({url}) | ENG-407: Session auth... | @dorkalev | 2026-02-04 | [📋 Report]({archive_url}) |
| [#106]({url}) | ENG-396: Simplify velocity... | @dorkalev | 2026-02-03 | [📋 Report]({archive_url}) |

## Linear Tickets

| Ticket | Title | Status |
|--------|-------|--------|
| [ENG-407]({linear_url}) | Session auth for browser API | Done |
| [ENG-396]({linear_url}) | Simplify rolling average | Done |
...
Monitor at: https://console.cloud.google.com/run?project=acme-core
```
...
Deployment:
  GitHub Actions: {url}
  Cloud Run:      https://console.cloud.google.com/run?project=acme-core
