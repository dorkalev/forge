...
Read `.forge` file to get `LINEAR_PROJECTS` (e.g., `PORTAL,ENGINEERING,INFRA,WORKER,DESIGN`).

Build regex patterns dynamically:
- `ENG-\d+` for ENGINEERING (example prefix)
- `TEAM-\d+`, `INFRA-\d+`, `PROJ-\d+`, `DESIGN-\d+`
...
╠══════════════════════════════════════════════════════════════╣
║ Tickets in commits:  ENG-123, ENG-124, ENG-125, DESIGN-42        ║
║ Tickets in PR body:  ENG-123, ENG-125                        ║
╠══════════════════════════════════════════════════════════════╣
║ ❌ MISSING FROM PR:  ENG-124, DESIGN-42                          ║
...
Example: "Fixed data processor Docker entrypoint to run job_entrypoint.py instead of processor."
