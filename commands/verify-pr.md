...
`git diff origin/origin/staging..HEAD --name-only` — check each file against spec, issue, ticket. Unspecced → add to ticket scope (update Linear), create new ticket, or note as infra/config.
