...
**IMPORTANT:** `--first-parent` ensures only commits authored on this branch are included. Without it, merging origin/staging pulls in all staging commits (e.g., ENG-449, ENG-452) and pollutes the ticket list.
