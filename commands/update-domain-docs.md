...
| `worker/*`, `services/upload/local_pipeline.py`, `packages/data-access/*` | `docs/data-pipeline.md` |
...
| `web/backoffice/routes.py`, `web/portal/*`, `worker/processor/*`, UI components | `docs/product.md` |
